...
def base_model_config(dataset):
  ...
  if cfg.DATASET == 'FISH':
    ...
    cfg.CLASS_NAMES = ('species_summer', 'species_other', 'species_windowpane',
                       'species_grey sole', 'species_fourspot', 'species_winter', 'species_plaice')
